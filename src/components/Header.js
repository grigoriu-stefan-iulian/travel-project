                    ...
                    <header className="container__inner">
                        <div className="">
                            <div className="header__first-row clearfix">
                                ...
                                <div className="pull-right flex-block">
                                    <div className="header__social-media">
                                        <a className="icon--fb" href="http://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook"><i></i></a>
                                        <a className="icon--google" href="http://google.com" target="_blank" rel="noopener noreferrer" title="Google"><i></i></a>
                                        <a className="icon--wiki" href="http://wiki.com" target="_blank" rel="noopener noreferrer" title="Wiki"><i></i></a>
                                        <a className="icon--youtube" href="http://youtube.com" target="_blank" rel="noopener noreferrer" title="Youtube"><i></i></a>
                                    </div>
                            ...
                            <div className="header__second-row clearfix">
                                <div className="header__logo pull-left">
                                    <a href="http://google.com"><img src={logoIcon} alt="Explore Icon" title="Exploore Website"></img></a>
                                </div>
